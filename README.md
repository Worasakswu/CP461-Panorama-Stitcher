...
| ชุดภาพ | ภาพ | ขนาด | กล้อง | ลักษณะเด่น |
|---|---:|---|---|---|
| building | 5 | 640×480 | iPhone 4S | อาคารกระจก/อิฐ, perspective ชัด |
| cafe | 5 | 1920×1080 | Pantech IM-A890S | ร้านกาแฟ, วัตถุใกล้กล้อง, แสงในร่ม/กลางแจ้งต่างกันมาก |
| city | 8 | 2048×1360 | Nikon D90 | ถนนหมู่บ้าน, หมุนกว้าง ~140° (ใช้ cylindrical) |
| class | 4 | 1600×1200 | Pantech IM-A890S | ห้องเรียน, มีคนอยู่ใกล้กล้อง (parallax) |
| house | 5 | 968×648 | Pentax K200D | บ้านและถนน, ย้อนแสง |
| textureless | 2 | 700×420, 550×423 | — | ผนังขาว + ท้องฟ้า/ทะเล (feature น้อย) ใช้ทดสอบกรณีที่ต่อไม่ได้ |

ภาพเหล่านี้ใช้เพื่อการศึกษาในรายวิชาเท่านั้น ลิขสิทธิ์เป็นของเจ้าของภาพ
